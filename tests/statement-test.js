...
describe('statement', () => {
  ...
  it('whileStatement', () => {
    expect(Parser.parse('while (this) {}', (parser) => parser.statement())).toEqual({
  ...
  it('doWhileStatement', () => {
    expect(Parser.parse('do {} while (this);', (parser) => parser.statement())).toEqual({
  ...
  it('tryStatement', () => {
    expect(Parser.parse('try {} catch (A e) {}', (parser) => parser.statement())).toEqual({
      type: 'TRY_STATEMENT',
  ...
  // it('switchStatement', () => {
  //   expect(Parser.parse('switch (this) {}', (parser) => parser.statement())).toEqual({

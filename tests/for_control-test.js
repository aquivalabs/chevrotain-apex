...
describe('forControl', () => {
  ...
  it('basicForStatement: expressionList: multiple', () => {
    expect(Parser.parse('this, super;;', (parser) => parser.forControl())).toEqual({
      type: 'BASIC_FOR_CONTROL',
      forInit: {
        type: 'EXPRESSION_LIST',
        list: [
  ...
  it('basicForStatement: variableDeclaration: simple', () => {
    expect(Parser.parse('integer i = 0;;', (parser) => parser.forControl())).toEqual({
      type: 'BASIC_FOR_CONTROL',
      forInit: {
  ...
  it('basicForStatement: variableDeclaration: multiple', () => {
    expect(Parser.parse('integer i = 0, j = 0;;', (parser) => parser.forControl())).toEqual({
      type: 'BASIC_FOR_CONTROL',
      forInit: {
        type: 'LOCAL_VARIABLE_DECLARATION',
        modifiers: [],
  ...
  it('basicForStatement: variableDeclaration with annotations', () => {
    expect(Parser.parse('@Bean final integer i = 0;;', (parser) => parser.forControl())).toEqual({
      type: 'BASIC_FOR_CONTROL',
      forInit: {
        type: 'LOCAL_VARIABLE_DECLARATION',
        modifiers: [
  ...
  it('basicForStatement: optionalExpression operatorExpression', () => {
    expect(Parser.parse('; i < array.length;', (parser) => parser.forControl())).toEqual({
      type: 'BASIC_FOR_CONTROL',
      forInit: undefined,
      expression: {
  ...
  it('enhancedForStatement', () => {
    expect(Parser.parse('Bean bean : Beans', (parser) => parser.forControl())).toEqual({
  ...
  it('enhancedForStatement: multiple annotations', () => {
    expect(Parser.parse('@Bean final Bean bean : Beans', (parser) => parser.forControl())).toEqual({
      type: 'ENHANCED_FOR_CONTROL',
      declaration: {
        type: 'LOCAL_VARIABLE_DECLARATION',
        modifiers: [

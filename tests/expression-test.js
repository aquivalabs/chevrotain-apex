...
describe('expression', () => {
  ...
  it('instanceofExpression', () => {
    expect(Parser.parse('this instanceof boolean', (parser) => parser.expression())).toEqual({
  ...
  it('instanceofExpression and operatorExpression', () => {
    expect(
      Parser.parse('this instanceof boolean && true', (parser) => parser.expression())
    ).toEqual({
  ...
  it('ifElseExpression', () => {
    expect(Parser.parse('this ? super : null', (parser) => parser.expression())).toEqual({
  ...
  it('qualifiedExpression and operatorExpression and if else', () => {
    expect(
      Parser.parse("this.list.isEmpty() && true ? 'a' : 'b'", (parser) => parser.expression())
    ).toEqual({
      type: 'OPERATOR_EXPRESSION',
      left: {
        type: 'QUALIFIED_EXPRESSION',
  ...
  it('qualifiedExpression and if else', () => {
    expect(
      Parser.parse("this.list.isEmpty() ? 'a' : 'b'", (parser) => parser.expression())
    ).toEqual({
      type: 'IF_ELSE_EXPRESSION',
      condition: {
        type: 'QUALIFIED_EXPRESSION',
  ...
  it('instanceofExpression with qualifiedExpression', () => {
    expect(Parser.parse('this.b instanceof Boolean', (parser) => parser.expression())).toEqual({
      type: 'INSTANCEOF_EXPRESSION',
      expression: {
        type: 'QUALIFIED_EXPRESSION',
        expression: {
  ...
  it('operatorExpression with qualifiedNameExpressiona and if else statement', () => {
    expect(Parser.parse("a = some.call() ? 'a' : 'b'", (parser) => parser.expression())).toEqual({
      type: 'OPERATOR_EXPRESSION',
      left: {
        type: 'IDENTIFIER',
        value: 'a',
  ...
  it('operatorExpression Less', () => {
    expect(Parser.parse('i < array.length', (parser) => parser.expression())).toEqual({
      type: 'OPERATOR_EXPRESSION',
      left: {
        type: 'IDENTIFIER',
        value: 'i',
  ...
  it('identifier.class with annotation', () => {
    expect(Parser.parse('@Bean A.class', (parser) => parser.expression())).toEqual({
      type: 'QUALIFIED_EXPRESSION',
      expression: {
        type: 'TYPE_TYPE',
        modifiers: [

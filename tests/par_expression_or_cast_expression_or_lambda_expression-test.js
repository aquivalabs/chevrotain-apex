...
describe('parExpressionOrCastExpressionOrLambdaExpression', () => {
  it('parExpression', () => {
    expect(
      Parser.parse('(this)', (parser) => parser.parExpressionOrCastExpressionOrLambdaExpression())
    ).toEqual({
      type: 'PAR_EXPRESSION',
      expression: {
        type: 'THIS',
  ...
  it('castExpression: identifier', () => {
    expect(
      Parser.parse('(A) this', (parser) => parser.parExpressionOrCastExpressionOrLambdaExpression())
    ).toEqual({
      type: 'CAST_EXPRESSION',
      castType: {
        type: 'IDENTIFIER',
  ...
  it('castExpression: followed by qualifiedExpressionRest and operatorExpressionRest', () => {
    expect(
      Parser.parse('((LazyObject) obj).getIdentifier() == getIdentifier()', (parser) =>
        parser.parExpressionOrCastExpressionOrLambdaExpression()
      )
    ).toEqual({

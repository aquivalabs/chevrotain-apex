...
describe('expressionStatement', () => {
  it('simple', () => {
    expect(Parser.parse('this;', (parser) => parser.expressionStatement())).toEqual({
  ...
  it('simple with line break \n', () => {
    expect(Parser.parse('this;\n', (parser) => parser.expressionStatement())).toEqual({
      type: 'EXPRESSION_STATEMENT',
      expression: {
        type: 'THIS',
      },
  ...
  it('simple with line break \r', () => {
    expect(Parser.parse('this;\r', (parser) => parser.expressionStatement())).toEqual({
      type: 'EXPRESSION_STATEMENT',
      expression: {
        type: 'THIS',
      },
